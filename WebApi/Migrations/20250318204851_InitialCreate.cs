        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Presentations_Halls_HallId",
                        column: x => x.HallId,
                        principalTable: "Halls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderToken = table.Column<Guid>(type: "char(36)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketOrders_Presentations_PresentationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Presentations_PresentationId",
                        column: x => x.PresentationId,
                        principalTable: "Presentations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketOrderItems_Seats_SeatId",
                        column: x => x.SeatId,
                        principalTable: "Seats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Presentations_HallId",
                table: "Presentations",
                column: "HallId");

            migrationBuilder.CreateIndex(
                name: "IX_Presentations_MovieId",
                table: "Presentations",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketOrderItems_SeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketOrders_PresentationId",
                table: "TicketOrders",
                column: "PresentationId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PresentationId_SeatId",
                table: "Tickets",
                columns: new[] { "PresentationId", "SeatId" },
                unique: true);
